...
const headCells = [
  ...
  { id: 'product_description', numeric: true, disablePadding: false, label: 'Description' },
  { id: 'is_active', numeric: true, disablePadding: false, label: 'Active' },
  { id: 'price', numeric: true, disablePadding: false, label: 'Price' },
  { id: 'offer_price', numeric: true, disablePadding: false, label: 'OfferPrice' },
  { id: 'offer_start_at', numeric: true, disablePadding: false, label: 'Offer Starts On' },
  { id: 'offer_end_at', numeric: true, disablePadding: false, label: 'Offer Ends On' },
];
...
export default function EnhancedTable(props) {
  ...
  const selectedProduct = () => rows.find(product => product.id == selected);
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{formatDate(row.offer_end_at)}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
